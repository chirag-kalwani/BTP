                ...
                <div className="modal fade" id="exampleModal" tabIndex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                                ...
                                <div>
                                    <form>
                                        ...
                                        <div className="form-floating mb-3">
                                            <select required={true} onBlur={handlefocus1} focused={focus1.toString()}
                                                id="product" onChange={onchange} value={newdetails.product_name}
                                        ...
                                        {/*Enter Quantity*/}
                                        <div className="form-floating mb-3">
                                            <input pattern={"^(0|[1-9][0-9]{0,9})$"} required={true}
                                                onBlur={handlefocus2} focused={focus2.toString()} type="text"
                                                name="new_quantity" id="quantity" placeholder='Not Used'
                            ...
                            <p className='error2'>* if submit button is disabled check the form fields ,they are
                                required and should be valid</p>
                        </div>
                    </div>
                </div>
